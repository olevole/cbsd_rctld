//# cc jail.c -lprocstat -ljail -lsqlite3 -I/usr/local/include -L/usr/local/lib
//# первая сырая/костыльная/эксперементальная редакция:
//#  опрашиваем раз в секунду и сохраняем метрики в jailsysdata
//# todo: создаем файл статсы по схеме
#include <sys/param.h>
#include <sys/jail.h>
